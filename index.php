...
/*
		 ...
		 <?php //include_once("./index/analytics/analyticstracking.php") ?>
		 	...
		 	<style>
				...
				#logo, #logo-a { left:220px; top:65px; width:170px; height:64px; padding:0; }
				...
				#titletv { top:140px; left:15px; border:0; text-decoration:underline; }
				#titleyt { top:513px; left:15px; border:0; text-decoration:underline; }
				#titleyt a , #titletw a { color:black; }
				#youtube { top:557px; left:15px; padding:0; margin:0; width:580px; height:327px; }
				#twitter { display:block; top:915px; left:15px; height:660px; width:580px; }
				#titletw { top:884px; left:15px; border:0; text-decoration:underline; }
				...
				//#rightad { top:5px; left:415px; min-height:100px; height:auto; width:auto; }
         		...
         		#tvdiv { z-index:100; width:580px; height:327px; left:15px; top:185px; padding:0; } /*vanaf hier alle elementen 80 pixels omhoog gezet*/
			...
			/* Second, Third and more Tiers	*/
		 	...
		 	<div id="header">
				<audio id="player" src="/media/index.php" metadata type="audio/mpeg"></audio>
			</div>
			...
			<!--	<div id="nowonradio">
				...
				<!--<div id="playlist">
		 		<ul id="playlist-ul">
		 			...
		 			<li>
		 				<a class="alink" id="lia3">Ons West Brabant - Stream</a>
		 			</li>
		 		</ul>
		 		</div> -->
		 		...
		 		<div id="tvdiv">
		 			<video id="tvplayer" class="video-js" preloaded="auto" controls data-setup="{}">
						<source src="https://ms7.mx-cd.net/tv/177-710139/Ons_West_Brabant_TV.smil/playlist.m3u8" type="application/x-mpegURL">                        
					</video>
		 		...
		 		<div id="twitter">
					<a class="twitter-timeline alink" data-lang="nl" data-width="580" data-height="660" href="https://twitter.com/OnsWestBrabant?ref_src=twsrc%5Etfw"></a>
		...
		<div id="middleRHeader">
			...
			document.getElementById("lia3").addEventListener("click", function() {
				changeContent('/media/index.php');
				document.getElementById('player').style.display='none';
				})
*/
